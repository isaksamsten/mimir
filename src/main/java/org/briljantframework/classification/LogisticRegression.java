...
import org.briljantframework.classification.optimization.BinaryLogisticFunction;
import org.briljantframework.classification.optimization.OptimizationUtils;
import org.briljantframework.classification.optimization.MultiClassLogisticFunction;
...
public class LogisticRegression extends AbstractClassifier {
  ...
  public DoubleArray estimate(Vector record) {
    ...
    if (k > 2) {
      ...
      double prob = OptimizationUtils.logistic(Arrays.dot(x, coefficients));
  ...
  public static class Evaluator
      implements org.briljantframework.evaluation.Evaluator<LogisticRegression> {
