...
import org.briljantframework.classifier.evaluation.ClassifierEvaluator;
...
public class ValidatorTest {
  ...
  public void testCreateValidator() throws Exception {
    ...
    Validator<Classifier> validator = new Validator<Classifier>(partitioner) {
      @Override
      protected Classifier fit(Predictor.Learner<? extends Classifier> learner, DataFrame x, Vector y) {
